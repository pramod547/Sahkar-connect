...
const styles = StyleSheet.create({
  ...
  fundLabel: { fontSize: 12, color: '#666666', fontWeight: 'bold', uppercase: true },
  ...
  catChip: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6, borderWith: 1, borderWidth: 1, borderColor: '#E5E7EB', backgroundColor: '#F9FAFB' },
  catChipActive: { borderColor: '#0B4F4A', backgroundColor: '#0B4F4A' },
  catText: { fontSize: 10, fontWeight: 'bold', color: '#666666' },
  catTextActive: { color: '#FFFFFF' },
  textArea: { borderWith: 1, borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 8, padding: 10, textAlignVertical: 'top', height: 80, fontSize: 13 },
