...
const styles = StyleSheet.create({
  ...
  content: { backgroundColor: '#FEFAF3', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24 },
  title: { fontSize: 20, fontWeight: 'bold', color: '#1B5E4B', textAlign: 'center' },
  subtitle: { fontSize: 13, color: '#C67B4C', fontWeight: 'bold', textAlign: 'center', marginTop: 2, marginBottom: 16 },
  langContainer: { flexDirection: 'row', justifyContent: 'center', gap: 10, marginBottom: 16 },
  langChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: '#E5E7EB', backgroundColor: '#FFFFFF' },
  langChipActive: { backgroundColor: '#1B5E4B', borderColor: '#1B5E4B' },
  langText: { fontSize: 12, fontWeight: 'bold', color: '#666666' },
  langTextActive: { color: '#FFFFFF' },
  speechBox: { backgroundColor: '#F5ECD7', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#C67B4C', minHeight: 60, justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  speechText: { fontSize: 14, fontWeight: 'bold', color: '#1B5E4B', textAlign: 'center' },
  commandList: { gap: 10, marginBottom: 20 },
  commandBtn: { backgroundColor: '#FFFFFF', paddingVertical: 14, paddingHorizontal: 16, borderRadius: 12, borderWidth: 1, borderColor: '#1B5E4B' },
  commandBtnText: { fontSize: 14, fontWeight: 'bold', color: '#1B5E4B' },
  closeBtn: { paddingVertical: 12, alignItems: 'center' },
  closeBtnText: { color: '#C67B4C', fontWeight: 'bold', fontSize: 14 },
});
