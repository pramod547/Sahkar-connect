  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full">
      <header className="flex justify-between items-center mb-8 pb-4 border-b border-gray-200">
        <div>
          <h1 className="text-2xl font-bold text-[#0B4F4A]">SahakarConnect Governance Portal</h1>
          <p className="text-sm text-gray-600">Cooperative Society & Federation Administration</p>
        </div>
        <div className="flex items-center space-x-3">
          <span className="bg-[#0B4F4A] text-white text-xs px-3 py-1.5 rounded-full font-medium">
